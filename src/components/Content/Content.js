...
function Content() {
  ...
  function setResiduary1() {
    ...
    if (totalShare === 100) {
      ...
      if (totalShare < 100)
        alert.show("Assign 100% of the residuary properties");
      else alert.show("More Than 100% Residuary Property Assigned");
    }
  }
  return (
        ...
        <Tabs selectedIndex={tabIndex}>
          <TabList>
            <Tab>
              ...
              >
                <p className="tab-progress">1</p>Personal Information
              </div>
            </Tab>
            ...
            <Tab>
              ...
              >
                <p className="tab-progress">2</p>Beneficiary
              </div>
            </Tab>
            <span className="connecting-line"></span>
            ...
            <Tab>
              ...
              >
                <p className="tab-progress">3</p>Assets
              </div>
            </Tab>
            <span className="connecting-line"></span>
            ...
            <Tab>
              ...
              >
                <p className="tab-progress">4</p>Your Will
              </div>
            </Tab>
          </TabList>
          ...
          <TabPanel>
            ...
            <form id="personal-form">
              <div className="form-row">
                ...
                <div
                  className="form-item"
                  style={{ width: "30%", marginLeft: "180px" }}
                >
                  <label>DOB</label>
                  <input
                    type="date"
              ...
              <p className="note-para">
                ...
                executor is to distribute the assets as mentioned by the author
                of the WILL.)
              </p>
              {executors?.map((executor, index) => (
                <div className="form-row">
                  ...
                  <div className="form-item">
                    ...
                    <input
                      value={executor["name"]}
                      onChange={(e) => setExecName(e, index)}
                    ></input>
                  </div>
                  <div className="form-item">
                    ...
                    <input
                      ...
                      onChange={(e) => setExecRelation(e, index)}
                    ></input>
                  </div>
                  {executors.length === 1 ||
              ...
              {getAge(benDOB) < 18 ? (
                <div>
                  ...
                  <p className="note-para">
                    ...
                    trustee and whatever assets are being receivable by a Minor
                    under WILL be maintained by a Guardian on behalf of a minor
                    till the time he turns 18 years of age.)
                  </p>
                  <div className="form-row">
                    <div className="form-item">
                      <label>Title: </label>
                      ...
                      <div>
                        <div className="form-row">
                          ...
                          <div className="form-item">
                            ...
                            <select
                              value={assetAreaUnit}
                              onChange={(e) => setAssetAreaUnit(e.target.value)}
                            >
                        ...
                        <div className="form-row address-row">
                          <div className="form-item">
                            ...
                            <input
                              style={{ width: "380px" }}
                              value={assetAddress1}
                              onChange={(e) => setAssetAddress1(e.target.value)}
                            ></input>
                          </div>
                        </div>
                        <div className="form-row address-row">
                          <div className="form-item">
                            ...
                            <input
                              style={{ width: "380px" }}
                              value={assetAddress2}
                              onChange={(e) => setAssetAddress2(e.target.value)}
                            ></input>
                          </div>
                        </div>
                        <div className="form-row">
                        ...
                        <div className="form-row">
                          ...
                          <div className="form-item">
                            ...
                            <input
                              value={assetCountry}
                              onChange={(e) => setAssetCountry(e.target.value)}
                            ></input>
                          </div>
                        </div>
                      </div>
...
kind of investment apart from the list mentioned above"
              ...
              <TabPanel>
                ...
                <p className="note-para">
                  (Note- If any of the previously-stated Beneficiary predecease
